...
TEST_F(SnakeGameTest, MoveSnakeUp) {
  ...
  EXPECT_EQ(snake_game_data_->game_status, s21::GameState_t::kStart);
  snake_model_.UpdateData(s21::UserAction_t::kSpaceBtn);
  EXPECT_EQ(snake_game_data_->game_status, s21::GameState_t::kSpawn);
  snake_model_.UpdateData(s21::UserAction_t::kNoSig);
  EXPECT_EQ(snake_game_data_->game_status, s21::GameState_t::kMoving);
...
TEST_F(SnakeGameTest, SetAndCancelPauseAndExit) {
  ...
  EXPECT_EQ(snake_game_data_->game_status, s21::GameState_t::kPause);
  snake_model_.UpdateData(s21::UserAction_t::kTabBtn);
  EXPECT_EQ(snake_game_data_->game_status, s21::GameState_t::kMoving);
  snake_model_.UpdateData(s21::UserAction_t::kEscBtn);
  EXPECT_EQ(snake_game_data_->game_status, s21::GameState_t::kGameOver);
}
...
TEST_F(SnakeGameTest, CollideGameOver) {
  ...
  snake_model_.UpdateData(s21::UserAction_t::kNoSig);
  EXPECT_EQ(snake_game_data_->game_status, s21::GameState_t::kMoving);
  while (snake_game_data_->game_status != s21::GameState_t::kGameOver) {
    snake_model_.UpdateData(s21::UserAction_t::kUp);
  }
}
